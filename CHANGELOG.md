...
- **Custom Scorer** You can now pass custom scorer for optimization in `tune_model` for `pycaret.classification` and `pycaret.regression`. New parameter `custom_scorer` has been added.
