...
def get_model_definition_regression(model_name):
    model_name_dict = {}
    return model_name_dict.get(model_name, None)
...
def get_plot_definition(plot):
    ...
    return plot_definition.get(plot, None)
