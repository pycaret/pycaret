...
def recommend_d(data: pd.Series, **kwargs) -> int:
    ...
    *kwargs: Keyword arguments that can be passed to the difference test.
    ...
    """
    recommended_d = pm.arima.ndiffs(data, **kwargs)
    return recommended_d


def recommend_D(data: pd.Series, sp: int, **kwargs) -> int:
    """Returns the recommended value of differencing order 'd' to use
    ...
    *kwargs: Keyword arguments that can be passed to the difference test.
    ...
    int
        The differencing order to use
    """
    recommended_D = pm.arima.ndsiffs(data, m=sp, **kwargs)
    return recommended_D
