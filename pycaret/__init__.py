...
# Pycaret only supports python 3.10, 3.11, 3.12
# This code is to avoid issues with python 3.9 or other not supported versions
# example (see package versions): https://github.com/pycaret/pycaret/issues/3746

if sys.version_info < (3, 10):
    raise RuntimeError(
        "Pycaret only supports python 3.10, 3.11, 3.12. Your actual Python version: ",
        sys.version_info,
