...
| 45+ | Phase 5d / 6 → 4.0.0 release | Strip legacy.setup() from `_native_setup_timeseries` (port seasonality auto-detection + native sktime split + fold_generator); delete pycaret/internal/pycaret_experiment; ship 4.0.0 |
