...
| 43+ | Phase 5c (cont.) / 5d / 6 → 4.0.0 release | Drain remaining TS verbs (tune / finalize / assign); strip legacy.setup() from `_native_setup_timeseries`; delete pycaret/internal/pycaret_experiment; ship 4.0.0 |
