...
| 40+ | setup() phase 5b/c → 4.0.0 release | Drain TS create_model / predict_model / compare_models / tune_model (uses sktime forecasters directly); then strip legacy.setup() from TS native path; delete pycaret/internal/pycaret_experiment; ship 4.0.0 |
